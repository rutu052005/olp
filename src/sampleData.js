    ...
    [
      {
        ...
        lessons: [
          { title: 'Course orientation', duration_minutes: 12, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
          { title: 'Key concepts and setup', duration_minutes: 24, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
          { title: 'Guided practice lab', duration_minutes: 36, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
        ],
      },
      {
        ...
        lessons: [
          { title: 'Implementation walkthrough', duration_minutes: 31, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
          { title: 'Case study', duration_minutes: 28, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
          { title: 'Practice assignment', duration_minutes: 44, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
        ],
      },
      {
        ...
        lessons: [
          { title: 'Concept recap', duration_minutes: 18, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
          { title: 'Assessment strategy', duration_minutes: 16, video_url: 'https://www.youtube.com/watch?v=aqz-KE-bpKQ' },
        ],
      },
    ],
  ]),
